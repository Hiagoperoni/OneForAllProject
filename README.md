...
<details>
  ...
  - Data de entrega para avaliação final do projeto: `13/12/2022 14:00`.
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-024-b-mysql-one-for-all.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-024-b-mysql-one-for-all`
